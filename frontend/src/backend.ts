...
import type { Category as _Category, Order as _Order, OrderId as _OrderId, OrderItem as _OrderItem, OrderStatus as _OrderStatus, Product as _Product, ProductId as _ProductId, Time as _Time } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async addProduct(arg0: string, arg1: string, arg2: Category, arg3: bigint, arg4: bigint, arg5: string): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, arg1, to_candid_Category_n1(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5);
    ...
    async placeOrder(arg0: string, arg1: string, arg2: string, arg3: Array<OrderItem>, arg4: bigint): Promise<Order> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: ProductId, arg1: string, arg2: string, arg3: Category, arg4: bigint, arg5: bigint, arg6: string): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, arg1, arg2, to_candid_Category_n1(this._uploadFile, this._downloadFile, arg3), arg4, arg5, arg6);
                return from_candid_Product_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? OrderStatus.pending : "dispatched" in value ? OrderStatus.dispatched : "delivered" in value ? OrderStatus.delivered : "processing" in value ? OrderStatus.processing : value;
}
function from_candid_variant_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "artSupplies" in value ? Category.artSupplies : "schoolSupplies" in value ? Category.schoolSupplies : "writing" in value ? Category.writing : "paper" in value ? Category.paper : "officeEssentials" in value ? Category.officeEssentials : value;
}
...
function to_candid_variant_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.artSupplies ? {
        artSupplies: null
    } : value == Category.schoolSupplies ? {
        schoolSupplies: null
    } : value == Category.writing ? {
        writing: null
    } : value == Category.paper ? {
        paper: null
    } : value == Category.officeEssentials ? {
        officeEssentials: null
    } : value;
}
